...
options = {
    'proxy': {
        'http': 'http://1b552cc6ab4ad260c24c__cr.au:a1a384bcb5a733ba@gw.dataimpulse.com:10019',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/c8da544b-09dc-4eef-bda2-35ef9be53dd4")
time.sleep(50000)
