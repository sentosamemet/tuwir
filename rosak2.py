...
options = {
    'proxy': {
        'http': 'http://561f94cd38fb822e1621__cr.sl:5e2abe314dedb92a@gw.dataimpulse.com:10002',
        'https': 'https://561f94cd38fb822e1621__cr.sl:5e2abe314dedb92a@gw.dataimpulse.com:10002',
...
driver.get("https://sepolia-faucet.pk910.de/#/mine/e73742cf-41e6-498b-8379-24ef47d9e153")
time.sleep(50000)
